...
#money
min(df2_mon_crt$k)<k_low; max(df2_mon_crt$k)>k_high; min(df2_mon_crt$AUC)<AUC_low; max(df2_mon_crt$AUC)>AUC_high

#time
min(df2_time_crt$k)<k_low; max(df2_time_crt$k)>k_high; min(df2_time_crt$AUC)<AUC_low; max(df2_time_crt$AUC)>AUC_high
